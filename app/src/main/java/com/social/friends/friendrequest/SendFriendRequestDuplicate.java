...
import com.social.friends.adapter.FriendProfilePostImageAdapterDuplicate;
                ...
                .addOnCompleteListener(new OnCompleteListener<String>() {
                    ...
                    public void onComplete(@NonNull Task<String> task) {
                        if (task.isSuccessful()) {
                            ...
                            Toast.makeText(SendFriendRequestDuplicate.this, task.getResult().toString(), Toast.LENGTH_SHORT).show();
                        }
                    }
                });
    }
