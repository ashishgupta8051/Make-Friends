package com.social.friends.friendrequest.chatting;
...
import com.social.friends.adapter.RetrieveMessageAdapter;
import com.social.friends.friendrequest.SendFriendRequest;
import com.social.friends.friendrequest.chatting.background.SelectWallpaper;
import com.social.friends.model.ChatMessages;
import com.social.friends.model.ExistsChatUser;
...
import com.social.friends.utils.SharedPrefManager;
...
public class ChatWithFriends extends AppCompatActivity {
    ...
    private void selectedImages(List<Uri> selected_message_image) {
        ...
        UserDetails.addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                UserDetails userDetails = snapshot.child(CurrentUserId).getValue(com.social.friends.model.UserDetails.class);
                UserDetails userDetails2 = snapshot.child(UserId).getValue(com.social.friends.model.UserDetails.class);
